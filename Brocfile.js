...
module.exports = function (broccoli) {
  ...
  var legacyFilesToAppend = [
    'firecheck/config/environment.js',
    'firecheck/config/environments/' + env + '.js',
    'jquery.js',
    'handlebars.js',
    'ember.js',
    'ic-ajax/main.js',
  ...
  appAndDependencies = preprocessJs(appAndDependencies, '/', 'firecheck');
  ...
  styles = preprocessCss(sourceTrees, 'firecheck/styles', '/assets');
